            ...
            <section class="">
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                    ...
                    <form class="w-full max-w-md mx-auto">   
                        ...
                        <p id="success" class="mt-2 text-sm text-green-600 dark:text-green-500 hidden"><span class="font-medium">Awesome!</span> You will be notified when The Road to Jansanity Playoff Challenge Launches.</p>
